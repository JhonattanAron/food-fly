export default function CardMenu(props) {
  return (
    <div
      style={{ width: "25vw" }}
      class="flex overflow-hidden drop-shadow-2xl bg-white rounded-lg shadow-lg"
    >
      <div class="w-1/3 bg-cover bg-landscape"></div>
      <div class="w-2/3 p-4">
        <h1 class="text-2xl font-bold text-gray-900">Tomorow</h1>
